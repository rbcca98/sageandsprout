...
const copy: ToolCopy = {
  ...
  hook:
    "Enter the first day of your last menstrual period (LMP) to instantly calculate your estimated due date (EDD), current pregnancy week, trimester, and key milestones — all based on Naegele's rule and ACOG guidelines. You can also calculate from a conception date or IVF transfer.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Going 1–2 weeks past your EDD is common — spontaneous labor can occur naturally up to 42 weeks. Most providers discuss induction of labor at 41–42 weeks, as the risk of placental insufficiency and other complications increases after 42 weeks. Always follow your provider's guidance.",
    },
  ],
  ...
  contentHtml: `
    ...
    <p>
      ...
      This estimate assumes a 28-day cycle with ovulation on day 14.
    </p>
    <p>
    ...
    <p>
      Only about <strong>4–5% of babies are born on their exact EDD</strong>. Research consistently shows
      that roughly 80% of births occur within 10 days of the calculated date, and approximately 95% within
      20 days. The EDD is best understood as the midpoint of a distribution, not a precise prediction.
    </p>
    <p>
    ...
    <ul>
      ...
      <li>
        <strong>Second trimester (weeks 14–27):</strong> Often called the "honeymoon trimester" — energy
        typically returns, morning sickness eases, and the baby grows rapidly.
