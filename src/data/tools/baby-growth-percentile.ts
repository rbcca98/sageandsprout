...
const copy: ToolCopy = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Not necessarily. Percentile by itself is less important than the trend over time. A baby consistently at the 10th percentile is growing normally. What warrants attention is a large drop across percentile lines between visits, which your pediatrician tracks at every well-child visit.',
    },
    {
